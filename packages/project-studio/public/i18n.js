...
const DICT = {
  en: {
    ...
    'soundtrack.music_placeholder': 'Describe the music — genre, mood, tempo (e.g. "calm cinematic ambient, slow build")',
    'soundtrack.narration_label': 'Narration / voiceover',
    'soundtrack.narration_placeholder': 'Text to read aloud over the video (leave empty for none)',
  ...
  zh: {
    ...
    'soundtrack.music_placeholder': '描述音乐 —— 风格、情绪、节奏（如「舒缓的电影感氛围，缓慢推进」）',
    'soundtrack.narration_label': '旁白 / 配音',
    'soundtrack.narration_placeholder': '在视频上朗读的文字（留空则不加）',
