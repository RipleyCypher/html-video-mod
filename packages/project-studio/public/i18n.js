...
const DICT = {
  en: {
    ...
    // Provider selection
    'soundtrack.music_provider': 'Music provider',
    'soundtrack.voice_provider': 'Voice provider',
    'soundtrack.provider_minimax': 'MiniMax',
    'soundtrack.provider_wavespeed': 'WaveSpeed (Ace-Step)',
    'soundtrack.provider_gemini': 'Gemini Flash TTS',
    'soundtrack.tags_placeholder': 'Style tags: lo-fi, chill, ambient, piano',
    'soundtrack.duration_label': 'Duration (seconds)',

    // Gemini voices
    'soundtrack.gemini_male_informative': 'Male · Informative',
    'soundtrack.gemini_male_firm': 'Male · Firm',
    'soundtrack.gemini_male_warm': 'Male · Warm',
    'soundtrack.gemini_male_gravelly': 'Male · Gravelly',
    'soundtrack.gemini_female_bright': 'Female · Bright',
    'soundtrack.gemini_female_breezy': 'Female · Breezy',
    'soundtrack.gemini_female_youthful': 'Female · Youthful',
    'soundtrack.gemini_female_gentle': 'Female · Gentle',
    ...
    'settings.audio.subtitle': 'Configure API keys for music and voiceover generation.',
    ...
    'settings.audio.not_configured': 'Not configured.',
    ...
    // MiniMax
    'settings.audio.minimax.title': 'MiniMax',
    'settings.audio.minimax.subtitle': 'Music (music-1.5) + Voiceover (speech-02-turbo)',
    'settings.audio.minimax.api_key_placeholder': 'Paste your MiniMax API key',
    'settings.audio.minimax.region': 'API region',
    'settings.audio.minimax.region_intl': '🌐 International · api.minimax.io',
    'settings.audio.minimax.region_cn': '🇨🇳 China · api.minimaxi.com',
    'settings.audio.minimax.base_url': 'Base URL',
    'settings.audio.minimax.hint': 'Stored locally in .html-video/media-config.json. Pick the region that matches your key — international and China keys are not interchangeable.',
    'settings.audio.minimax.not_configured': 'No MiniMax key configured yet.',

    // WaveSpeed
    'settings.audio.wavespeed.title': 'WaveSpeed',
    'settings.audio.wavespeed.subtitle': 'Music — Ace-Step 1.5 (up to 4min tracks, ultra-low cost)',
    'settings.audio.wavespeed.api_key_placeholder': 'Paste your WaveSpeed API key',
    'settings.audio.wavespeed.base_url': 'Base URL',
    'settings.audio.wavespeed.hint': 'Stored locally in .html-video/media-config.json. Get your key at wavespeed.ai/accesskey.',
    'settings.audio.wavespeed.not_configured': 'No WaveSpeed key configured yet.',

    // Gemini
    'settings.audio.gemini.title': 'Gemini',
    'settings.audio.gemini.subtitle': 'Voiceover — Flash TTS (expressive, 30+ languages)',
    'settings.audio.gemini.api_key_placeholder': 'Paste your Gemini API key',
    'settings.audio.gemini.hint': 'Stored locally in .html-video/media-config.json. Get your key at aistudio.google.com/apikey.',
    'settings.audio.gemini.not_configured': 'No Gemini key configured yet.',
  ...
  zh: {
    ...
    // Provider selection
    'soundtrack.music_provider': '音乐提供商',
    'soundtrack.voice_provider': '语音提供商',
    'soundtrack.provider_minimax': 'MiniMax',
    'soundtrack.provider_wavespeed': 'WaveSpeed (Ace-Step)',
    'soundtrack.provider_gemini': 'Gemini Flash TTS',
    'soundtrack.tags_placeholder': '风格标签：lo-fi, chill, ambient, piano',
    'soundtrack.duration_label': '时长（秒）',

    // Gemini voices
    'soundtrack.gemini_male_informative': '男声 · 沉稳',
    'soundtrack.gemini_male_firm': '男声 · 坚定',
    'soundtrack.gemini_male_warm': '男声 · 温暖',
    'soundtrack.gemini_male_gravelly': '男声 · 沙哑',
    'soundtrack.gemini_female_bright': '女声 · 明亮',
    'soundtrack.gemini_female_breezy': '女声 · 轻快',
    'soundtrack.gemini_female_youthful': '女声 · 年轻',
    'soundtrack.gemini_female_gentle': '女声 · 温柔',
    ...
    // MiniMax
    'settings.audio.minimax.title': 'MiniMax',
    'settings.audio.minimax.subtitle': '音乐 (music-1.5) + 语音 (speech-02-turbo)',
    'settings.audio.minimax.api_key_placeholder': '粘贴你的 MiniMax API key',
    'settings.audio.minimax.region': 'API 区域',
    'settings.audio.minimax.region_intl': '🌐 国际 · api.minimax.io',
    'settings.audio.minimax.region_cn': '🇨🇳 国内 · api.minimaxi.com',
    'settings.audio.minimax.base_url': 'Base URL',
    'settings.audio.minimax.hint': '保存在本地 .html-video/media-config.json。请按你的 key 选对区域——国际版和国内版的 key 不能互换。',
    'settings.audio.minimax.not_configured': '尚未配置 MiniMax key。',

    // WaveSpeed
    'settings.audio.wavespeed.title': 'WaveSpeed',
    'settings.audio.wavespeed.subtitle': '音乐 — Ace-Step 1.5（最长 4 分钟，超低成本）',
    'settings.audio.wavespeed.api_key_placeholder': '粘贴你的 WaveSpeed API key',
    'settings.audio.wavespeed.base_url': 'Base URL',
    'settings.audio.wavespeed.hint': '保存在本地 .html-video/media-config.json。在 wavespeed.ai/accesskey 获取 key。',
    'settings.audio.wavespeed.not_configured': '尚未配置 WaveSpeed key。',

    // Gemini
    'settings.audio.gemini.title': 'Gemini',
    'settings.audio.gemini.subtitle': '语音 — Flash TTS（富有表现力，支持 30+ 种语言）',
    'settings.audio.gemini.api_key_placeholder': '粘贴你的 Gemini API key',
    'settings.audio.gemini.hint': '保存在本地 .html-video/media-config.json。在 aistudio.google.com/apikey 获取 key。',
    'settings.audio.gemini.not_configured': '尚未配置 Gemini key。',
